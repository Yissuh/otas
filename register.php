...
<div class="h-100 d-flex  align-items-center w-100" id="login">
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
        ...
        <h1 class="text-center py-5 login-title" style="font-family: 'Inter', sans-serif;"><b><?php echo $_settings->info('name') ?> - Sign Up</b></h1>
      </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <select name="curriculum_id" id="curriculum_id" class="form-control form-control-border select2" data-placeholder="Select Curriculum" required>
