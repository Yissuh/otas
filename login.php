    ...
    <div class="col-7 h-100 d-flex align-items-center justify-content-center">
      <div class="w-100">
            <div id="logo-container">
                <!-- Wrap the logo inside an anchor tag -->
                <a href="<?php echo base_url ?>">
                    <img src="<?= validate_image($_settings->info('logo')) ?>" alt="" id="logo-img">
                </a>
            </div>
        <h1 class="text-center py-5 login-title" style="font-family: 'Inter', sans-serif;"><b><?php echo $_settings->info('name') ?></b></h1>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group text-right">
                                    <a href="register.php" class="btn btn-default bg-navy btn-flat">Register</a>
